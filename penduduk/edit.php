                    ...
                    <header class="navbar navbar-inverse navbar-fixed-top">
                        ...
                        <ul class="nav navbar-nav-custom">
                            ...
                            <li class="hidden-xs animation-fadeInQuick">
                                <a href="../pilihan.php"><strong>SELAMAT DATANG DI SWARGA15</strong></a>
                            </li>
                            <!-- END Header Link -->
                        </ul>
                                ...
                                <div class="col-sm-6 hidden-xs">
                                    <div class="header-section">
                                        <ul class="breadcrumb breadcrumb-top">
                                            <li><a href="../dashboard">SWARGA15</a></li>
                        ...
                        <div class="block">
                            ...
                            <form action="edit.php?id<?php echo $edit['nik']; ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-actions">
                                    <div class="col-md-12">
                                        <button type="submit" name="edit_proses" class="btn btn-effect-ripple btn-primary">Simpan</button>
